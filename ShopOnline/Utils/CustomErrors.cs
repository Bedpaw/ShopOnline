namespace ShopOnline.Utils
{
    public static class CustomErrors
    {
        ...
        public static string NotEnoughProductsInStore(string product, int youWant, decimal inStore) =>
            $"You tried to buy {product} - {youWant}, but only {inStore} available. Order denied.";
